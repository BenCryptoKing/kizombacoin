...
#if defined(ANDROMEDA_NEED_QT_PLUGINS) && !defined(_ANDROMEDA_QT_PLUGINS_INCLUDED)
#define _ANDROMEDA_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
