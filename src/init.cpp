...
void Shutdown()
{
    ...
    RenameThread("kizombacoin-shutoff");
...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: kizombacoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: kizombacoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 9333 or testnet: 8333)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 19333 or testnet: 18333)") + "\n";
    ...
    strUsage += "  -loadblock=<file>      " + _("Imports blocks from external kmc000?.dat file") + "\n";
